document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderBalance = () => {
        ...
        const balanceText = `= ${formattedRewards} (🪙 ${availableCoins})`;
        coinEquivalent.textContent = balanceText;
        exchangeBalanceAmount.textContent = formattedRewards;
        exchangeCoinBalance.textContent = balanceText;
    };
    ...
    const resetSuccessDetails = () => {
        ...
        document.getElementById('successSummary').textContent = 'You exchanged for 🪙 10,000,000 Coins';
    };
    ...
    exchangeForm.addEventListener('submit', (event) => {
        ...
        setTimeout(() => {
            ...
            document.getElementById('successSummary').textContent = `You exchanged for 🪙 ${transaction.coins.toLocaleString('en-US')} Coins`;
            exchangeScreen.classList.add('hidden');
